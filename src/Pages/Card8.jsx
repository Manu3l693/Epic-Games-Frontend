...
export const Card8 = (props) => {
    ...
    return(
        <>
           <div className="card8_card" key={id} style={{width: widthSize}}>
                    <Link to={link}>
                        <div className="car8_card_">
                            <div className="card8_image" onMouseEnter={handleHoverCard} onMouseLeave={handleHoverLeave}>
                                <div className="hidden_container8" style={{display: cardHover}}>
                                    <div className="bookmark_hidden8" style={{width: width, height: height, border: border, borderRadius: borderRadius, transition: transition}} onMouseEnter={onHiddenHover} onMouseLeave={onHiddenLeave}>
