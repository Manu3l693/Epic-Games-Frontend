...
export const FirstRun = () => {
            ...
            const product2 = [
                {id: 1, image: blood,        genre: 'Base Game', name: 'Farcana',                           button: 'First Run',    available: 'Coming Soon', link: '/Hello'},
                {id: 2, image: gigaSword,    genre: 'Base Game', name: 'Stellar Subterranean',              button: 'First Run',    available: 'Coming Soon', link: '/Hello'},
                {id: 3, image: callOfDuty,   genre: 'Base Game', name: 'Super Miaoyin',                     price: 'Free',          color: 'white',           link: '/Hello'},
                {id: 4, image: mortalKombat, genre: 'Base Game', name: 'Guards II: Chaos in Hell',          button: 'First Run',    price: 'Free',            link: '/Hello'},
                {id: 5, image: Anno,         genre: 'Base Game', name: 'Space Road: Elite',                 button: 'First Run',    price: '$12.99',          link: '/Hello'},
            ]
                ...
                <div className="discover_something_new">
                    <div className="discover_something_new_1">
                        <div className="discover_something_new_header">
                           {isAuthenticated ? (
                            <>
                                <Link to='/Hello'> Featured From Epic First Run <i class="fa-solid fa-greater-than"></i> </Link> 
                            </>
                           ) : (
                            <>
                                ...
                                <Swiper
                                    ...
                                    <SwiperSlide>
                                        {isAuthenticated ? (
                                            ...
                                            <>
                                                <div className="swiper_items_"> 
                                                    <Card7 key={product1[0].id} image={product1[0].image} genre={product1[0].genre} name={product1[0].name} button={product1[0].button} discount={product1[0].discount} stroke={product1[0].stroke} price={product1[0].price} link='/login'/>
                                                    <Card8 key={product1[1].id} image={product1[1].image} genre={product1[1].genre} name={product1[1].name} button={product1[1].button} price={product1[1].price} link='/login'/>
                                                    <Card7 key={product1[2].id} image={product1[2].image} genre={product1[2].genre} name={product1[2].name} button={product1[2].button} discount={product1[2].discount} stroke={product1[2].stroke} price={product1[2].price} link='/login'/>
                                                    <Card8 key={product1[3].id} image={product1[3].image} genre={product1[3].genre} name={product1[3].name} button={product1[3].button} price={product1[3].price} link='/login'/>
                                                    <Card7 key={product1[4].id} image={product1[4].image} genre={product1[4].genre} name={product1[4].name} button={product1[4].button} discount={product1[4].discount} stroke={product1[4].stroke} price={product1[4].price} link='/login'/>
                                                </div>
                                            </>
                                        )}
                                    </SwiperSlide>
                                    ...
                                    <SwiperSlide>
                                        <div className="swiper_items_">
                                            {isAuthenticated ? (
                                                ...
                                                <>
                                                    <Card9 key={product2[0].id} image={product2[0].image} genre={product2[0].genre} name={product2[0].name} button={product2[0].button} available={product2[0].available} link='/login'/>
                                                    <Card9 key={product2[1].id} image={product2[1].image} genre={product2[1].genre} name={product2[1].name} button={product2[1].button} available={product2[1].available} link='/login'/>
                                                    <Card1 key={product2[2].id} image={product2[2].image} genre={product2[2].genre} name={product2[2].name} price={product2[2].price}  color={product2[2].color} link='/login'/>
                                                    <Card8 key={product2[3].id} image={product2[3].image} genre={product2[3].genre} name={product2[3].name} button={product2[3].button} price={product2[3].price} link='/login'/>
                                                    <Card8 key={product2[4].id} image={product2[4].image} genre={product2[4].genre} name={product2[4].name} button={product2[4].button} price={product2[4].price} link='/login'/>
                                                </>
                                            )}
                                        </div>
                                    </SwiperSlide>
