...
export const Card10 = (props) => {
    ...
    return(
        <>
            <div className="card10_card" key={id} style={{width: widthSize}}>
                    <Link to={link}>
                        <div className="car10_card_">
                            <div className="card10_image" onMouseEnter={handleHoverCard} onMouseLeave={handleHoverLeave}>
                                <div className="hidden_container10" style={{display: cardHover}}>
                                    <div className="bookmark_hidden10" style={{width: width, height: height, border: border, borderRadius: borderRadius, transition: transition}} onMouseEnter={onHiddenHover} onMouseLeave={onHiddenLeave}>
