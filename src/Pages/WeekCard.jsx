...
export const WeekCard = () => {
    ...
    const weeklyCards = [
        {id: 1, image: weekFort, header: 'This Week in Fortnite', text: "Check out the latest updates in fortnite from classic Battle Royale to Blitz and Delulu. There's always something new in Fortnite!", button: 'Discover Now', link: '/login'},
        {id: 2, image: hogwarts, header: 'Hogwarts Legacy is Free', text: "Play two hours of Hogwarts Legacy by December 18 to unlock the Chocolate Frog Back Bling in Fortnite!", button: 'Get It Free', link: '/login'},
        {id: 3, image: prowler, header: 'Fortnite', text: 'Just try and keep up! Prowler comes to Fortnite with customizable Outfits and more.', button: "See In Shop", link: '/login'},
    ]
