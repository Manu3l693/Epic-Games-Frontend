...
export const Card6 = (props) => {
    ...
    return(
        <>
           <div className="card6_card" key={id} style={{width: widthSize}}>
                    <Link to={link}>
                        <div className="car6_card_">
                            <div className="card6_image" onMouseEnter={handleHoverCard} onMouseLeave={handleHoverLeave}>
                                <div className="hidden_container6" style={{display: cardHover}}>
                                    <div className="bookmark_hidden6" style={{width: width, height: height, border: border, borderRadius: borderRadius, transition: transition}} onMouseEnter={onHiddenHover} onMouseLeave={onHiddenLeave}>
