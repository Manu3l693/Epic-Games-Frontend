...
export const GameStore = () => {
                ...
                const product1 = [
                    {id: 1, image: battlefield1, genre: 'Base Game', name: 'Poly Plaza ULTIMATE',                           available: 'Now On Epic', price: '$2.19', link: '/Hello'},
                    {id: 2, image: windsMeet,    genre: 'Base Game', name: 'Bloodstained: Ritual of the Night',             available: 'Now On Epic', price: '$13.99', link: '/Hello'},
                    {id: 3, image: warFrame,     genre: 'Base Game', name: 'Wild West Saga',                                available: 'Now On Epic', price: 'Free', link: '/Hello'},
                    {id: 4, image: starTrek,     genre: 'Base Game', name: 'The Pedestrian',                                available: 'Now On Epic', discount: '-40%', stroke:'$8.99', price: '$5.39', link: '/Hello'},
                    {id: 5, image: morsel,       genre: 'Base Game', name: "Rise of the Penguins 2", available: 'Now On Epic',                         price: '$1.29', link: '/Hello'},
                ]
            
                const product4 = [
                    {id: 1, image: blood,        genre: 'Base Game', name: "Kaya's Prophecy",             available:'Now On Epic',  discount:'-40%', stroke: '$6.29', price: '$3.77', link: '/Hello'},
                    {id: 2, image: gigaSword,    genre: 'Base Game', name: 'Hoomanz!',                    available:'Now On Epic',  price: '$2.19', link: '/Hello'},
                    {id: 3, image: callOfDuty,   genre: 'Base Game', name: 'Tales from The Dancing Moon', available:'Now On Epic',  discount: '-40%', stroke: '$7.19', price: '$4.31', link: '/Hello'},
                    {id: 4, image: mortalKombat, genre: 'Base Game', name: 'Stardash',                    available:'Now On Epic',  price: '$2.49', link: '/Hello'},
                    {id: 5, image: Anno,         genre: 'Base Game', name: 'KAKU: Ancient Seal',          available:'Now On Epic',  discount: '-40%', stroke: '$11.19', price: '$6.71', link: '/Hello'},
                ]
            
                const product5 = [
                    {id: 1, image: FortFestival,   genre: 'Base Game', name: 'Gloomy Eyes',              available:'Now On Epic', price: '$11.19',    link: '/Hello'},
                    {id: 2, image: Rue,            genre: 'Base Game', name: "Snake Core",               available:'Now On Epic', price: '$2.49', link: '/Hello'},
                    {id: 3, image: SurvivingMars,  genre: 'Base Game', name: 'Kellan Graves: Fallen',    available:'Now On Epic', price: '$2.19',  link: '/Hello'},
                    {id: 4, image: PMR,            genre: 'Base Game', name: 'Botany Manor',             price: '$6.49', link: '/Hello'},
                    {id: 5, image: Wallworld2,     genre: 'Base Game', name: 'Sir Questionnaire',        price: '$2.49',  link: '/Hello'},
                ]
    return(
        <>
                           ...
                           <div className="discover_something_new">
                               <div className="discover_something_new_1">
                                   <div className="discover_something_new_header">
                                      {isAuthenticated ? (
                                        <>
                                            <Link to='/Hello'> Now On The Epic Game Store </Link> 
                                        </>
                                      ) : (
                                        <>
                                            <Link to='/login'> Now On The Epic Game Store </Link> 
                                        </>
                                      )}
                                   </div>
                                                   ...
                                                   <SwiperSlide>
                                                       <div className="swiper_items_">
                                                          {isAuthenticated ? (
                                                            ...
                                                            <>
                                                                <Card10 key={product1[0].id} image={product1[0].image} genre={product1[0].genre} name={product1[0].name} available={product1[0].available} price={product1[0].price} link='/login'/>
                                                                <Card10 key={product1[1].id} image={product1[1].image} genre={product1[1].genre} name={product1[1].name} available={product1[1].available} price={product1[1].price} link='/login'/>
                                                                <Card10 key={product1[2].id} image={product1[2].image} genre={product1[2].genre} name={product1[2].name} available={product1[2].available} price={product1[2].price} link='/login'/>
                                                                <Card6  key={product1[3].id} image={product1[3].image} genre={product1[3].genre} name={product1[3].name} available={product1[3].available} discount={product1[3].discount} stroke={product1[3].stroke} price={product1[3].price} link='/login'/>
                                                                <Card10 key={product1[4].id} image={product1[4].image} genre={product1[4].genre} name={product1[4].name} available={product1[4].available} price={product1[4].price} link='/login'/>
                                                            </>
                                                          )}
                                                       </div>
                                                   </SwiperSlide>
                                                   ...
                                                   <SwiperSlide>
                                                       <div className="swiper_items_">
                                                           {isAuthenticated ? (
                                                            ...
                                                            <>
                                                                <Card6  key={product4[0].id}  image={product4[0].image} genre={product4[0].genre} name={product4[0].name} available={product4[0].available} discount={product4[0].discount} stroke={product4[0].stroke} price={product4[0].price} link='/login'/>   
                                                                <Card10 key={product4[1].id}  image={product4[1].image} genre={product4[1].genre} name={product4[1].name} available={product4[1].available} price={product4[1].price} link='/login'/>                                                        
                                                                ...
                                                                <Card10 key={product4[3].id}  image={product4[3].image} genre={product4[3].genre} name={product4[3].name} available={product4[3].available} price={product4[3].price} link='/login'/>
                                                                <Card6  key={product4[4].id}  image={product4[4].image} genre={product4[4].genre} name={product4[4].name} available={product4[4].available} discount={product4[4].discount} stroke={product4[4].stroke} price={product4[4].price} link='/login'/>  
                                                            </>
                                                           )}
                                                       </div>
                                                   </SwiperSlide>
                                                   ...
                                                   <SwiperSlide>
                                                       <div className="swiper_items_">
                                                           {isAuthenticated ? (
                                                            ...
                                                            <>
                                                                <Card10 key={product5[0].id} image={product5[0].image} genre={product5[0].genre} name={product5[0].name} available={product5[0].available} price={product5[0].price} link='/login'/>
                                                                <Card10 key={product5[1].id} image={product5[1].image} genre={product5[1].genre} name={product5[1].name} available={product5[1].available} price={product5[1].price} link='/login'/>
                                                                <Card10 key={product5[2].id} image={product5[2].image} genre={product5[2].genre} name={product5[2].name} available={product5[2].available} price={product5[2].price} link='/login'/>
                                                                <Card1  key={product5[3].id} image={product5[3].image} genre={product5[3].genre} name={product5[3].name} price={product5[3].price} link='/login'/>
