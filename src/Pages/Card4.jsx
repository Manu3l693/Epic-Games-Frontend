...
export const Card4 = (props) => {
    ...
    return(
        <>
           <div className="card4_card" key={id} style={{width: widthSize}}>
                    <Link to={link}>
                        <div className="car4_card_">
                            <div className="card4_image" onMouseEnter={handleHoverCard} onMouseLeave={handleHoverLeave}>
                                <div className="hidden_container4" style={{display: cardHover}}>
                                    <div className="bookmark_hidden4"  style={{width: width, height: height, border: border, borderRadius: borderRadius, transition: transition}} onMouseEnter={onHiddenHover} onMouseLeave={onHiddenLeave}>
