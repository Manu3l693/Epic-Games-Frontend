...
export const Trending = () => {
                ...
                const product = [
                    {id: 1, image: paradise, genre: 'Base Game', name: 'Paradise Killer',              discount: '-100%',   stroke: '$7.99',  price:'Free', link: '/Hello'},
                    {id: 2, image: Ark, genre: 'Base Game', name: 'ARK: Survival Ascended',       price:'Coming soon', color: '#a8a8a8ff',    link: '/Hello'},
                    {id: 3, image: Sorry, genre: 'Base Game', name: "Sorry We're Closed",           price:'$9.99',       color: '#fff',  link: '/Hello'},
                    {id: 4, image: Avatar, genre: 'Base Game', name: 'Avatar: Frontiers of Pandora', discount: '-33%',    stroke: '$29.99', price:'$20.09', link: '/Hello'},
                    {id: 5, image: Tides, genre: 'Base Game', name: 'Tides of Annihilation',        price:'Coming Soon', color: '#a8a8a8ff',    link: '/Hello'},
                ]
    return(
        <> 
                    ...
                    <div className="trending_11">
                        ...
                        <div className="trending_products">
                            {isAuthenticated ? (
                                ...
                                <>
                                    <Card2 key={product[0].id} image={product[0].image} genre={product[0].genre} name={product[0].name} discount={product[0].discount} stroke={product[0].stroke} price={product[0].price} link='/login'/>
                                    <Card1 key={product[1].id} image={product[1].image} genre={product[1].genre} name={product[1].name} price={product[1].price} color={product[1].color} link='/login'/>
                                    <Card1 key={product[2].id} image={product[2].image} genre={product[2].genre} name={product[2].name} price={product[2].price} color={product[2].color} link='/login'/>
                                    <Card2 key={product[3].id} image={product[3].image} genre={product[3].genre} name={product[3].name} discount={product[3].discount} stroke={product[3].stroke} price={product[3].price} link='/login'/>
                                    <Card1 key={product[4].id} image={product[4].image} genre={product[4].genre} name={product[4].name} price={product[4].price} color={product[4].color} link='/login'/>
                                </>
                            )}
                        </div>
                    </div>
