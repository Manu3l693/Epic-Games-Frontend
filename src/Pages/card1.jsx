...
export const Card1 = (props) => {
    ...
    return(
        <>
                ...
                <div className="card1_card" key={id} style={{width: widthSize}}>
                    <Link to={link}>
                        <div className="car1_card_">
                            <div className="card1_image" onMouseEnter={handleHoverCard} onMouseLeave={handleHoverLeave}>
                                <div className="hidden_container" style={{display: cardHover}}>
                                    <div className="bookmark_hidden" style={{width: width, height: height, border: border, borderRadius: borderRadius, transition: transition}} onMouseEnter={onHiddenHover} onMouseLeave={onHiddenLeave}>
