...
export const TopSellers = () => {
    ...
    const product1 = [
        {id: 1, image: EAsport,    header: 'EA SPORTS FC 26 Standard Edition',   button: 'Trial Available',   discount: '-60%',   stroke: '$69.99', price: '$27.99', link: '/Hello'},
        {id: 2, image: ArcRaider,  header: 'ARC Raiders',                        discount: '-20%',            stroke: '$39.99',   price: '$31.99', link: '/Hello'},
        {id: 3, image: GTA,        header: 'Grand Theft Auto V Enhanced',        discount: '-50%',            stroke: '$29.99',   price: '$14.99', link: '/Hello'},
        {id: 4, image: Hogwart,    header: 'Hogwarts Legacy',                    price: '$59.99',             color: '#fff',    link: '/Hello'},
        {id: 5, image: BattlField, header: 'Battlefield 6',                      discount: '-30%',            stroke: '$69.99',   price: '$48.99', link: '/Hello'},
    ]

    const product2 = [
        {id: 1, image: fortNite,      header: 'Fortnite',         price: 'Free',    color: '#fff',             link: '/Hello'},
        {id: 2, image: Hogwart,       header: 'Hogwarts Legacy',                    price: '$59.99',             color: '#fff',    link: '/Hello'},
        {id: 3, image: RocketLeagues, header: 'Rocket League',                      price: 'Free',               color: '#fff',    link: '/Hello'},
        {id: 4, image: GTA,           header: 'Grand Theft Auto V Enhanced',        discount: '-50%',            stroke: '$29.99',   price: '$14.99', link: '/Hello'},
        {id: 5, image: jotunn,        header: 'Jotunnslayer: Hordes of Hel',        discount: '-25%',            stroke: '$5.99',    price: '$4.49', link: '/Hello'},
    ]

    const product3 = [
        {id: 1, image: Mongil,      header: 'MONGIL: STAR DIVE',       button: 'First Run',     price: 'Coming Soon', link: '/Hello'},
        {id: 2, image: Tides,       header: 'Tides of Annihilation',   price: 'Coming Soon',    color: 'grey',        link: '/Hello'},
        {id: 3, image: SubNautica,  header: 'Subnautica 2',            price: 'Coming Soon',    color: 'grey',        link: '/Hello'},
        {id: 4, image: outOf,       header: 'Out of Words',            price: 'Coming Soon',    color: 'grey',        link: '/Hello'},
        {id: 5, image: jurassic,    header: 'Jurassic Park: Survival', price: 'Coming Soon',    color: 'grey',        link: '/Hello'},
    ]
                        ...
                        <div className="most_played_1">
                            ...
                            <div className="top_Seller_content">
                                {isAuthenticated ? (
                                    ...
                                    <>
                                        <TopCont1 key={product1[0].id} image={product1[0].image} header={product1[0].header} button={product1[0].button} discount={product1[0].discount} stroke={product1[0].stroke} price={product1[0].price} link='/login'/>
                                        ...
                                        <TopCont2 key={product1[2].id} image={product1[2].image} header={product1[2].header} discount={product1[2].discount} stroke={product1[2].stroke} price={product1[2].price} link='/login'/>
                        ...
                        <div className="most_played_1">
                            ...
                            <div className="top_Seller_content">
                                {isAuthenticated ? (
                                    ...
                                    <>
                                        <TopCont3 key={product2[0].id} image={product2[0].image} header={product2[0].header} price={product2[0].price} color={product2[0].color} link='/login'/>
                                        <TopCont3 key={product2[1].id} image={product2[1].image} header={product2[1].header} price={product2[1].price} color={product2[1].color} link='/login'/>
                                        <TopCont3 key={product2[2].id} image={product2[2].image} header={product2[2].header} price={product2[2].price} color={product2[2].color} link='/login'/>
                                        <TopCont2 key={product2[3].id} image={product2[3].image} header={product2[3].header} discount={product2[3].discount} stroke={product2[3].stroke} price={product2[3].price} link='/login'/>
                                        <TopCont2 key={product2[4].id} image={product2[4].image} header={product2[4].header} discount={product2[4].discount} stroke={product2[4].stroke} price={product2[4].price} link='/login'/>
                                    </>
                                )}
                            </div>
                        </div>
                         ...
                         <div className="most_played_1">
                            ...
                            <div className="top_Seller_content">
                                {isAuthenticated ? (
                                    ...
                                    <>
                                        <TopCont4 key={product3[0].id} image={product3[0].image} header={product3[0].header} button={product3[0].button} price={product3[0].price} link='/login'/>
                                        ...
                                        <TopCont3 key={product3[3].id} image={product3[3].image} header={product3[3].header} price={product3[3].price} color={product3[3].color} link='/login'/>
